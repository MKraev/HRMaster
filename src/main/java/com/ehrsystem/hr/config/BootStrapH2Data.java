...
//
//        JobPost jobPosted5 = new JobPost("Managing director","Manage the company",
//                "Over 20 years of experience in corporate environment",
//                "Sofia",teo);
//
...
//
//        viki.getJobApplied().add(jobPosted5);
//        vili.getJobApplied().add(jobPosted5);
//
//        jobPosted5.getUsersApplied().add(viki);
//        jobPosted5.getUsersApplied().add(vili);
//
//        jobPostRepository.save(jobPosted5);
//        userRepository.save(vili);
//        userRepository.save(viki);
